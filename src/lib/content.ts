...
export const LETTER_CONTENT: LetterContent = {
  ...
  paragraphs: [
    ...
    "بص، أزعملي هحاول مسرحش في الكلام أو أكون إيموشنال بزيادة، لكن لازم أقولك كل سنة وإنت طيب يا أبو عمو، وعقبال مليون سنة يا رب، وتحقق كل أحلامك، وتخلف البنت اللي نفسك فيها، وتعيش الحياة اللي تستحقها.",
    ...
    "كنت جنبي قبل الحلوة، وسندتني في أسوأ فترات حياتي. شفتني في أسوأ نسخة مني، وبرغم ده كله قررت تفضل موجود، وتفضل صاحبي.",
